...
export default function ChatsSidebar({ chatID, personaBundle, syncChatHistory, setChatID }: ChatsSideBarProps) {
  ...
  const sidebarVariants = {
    open: { width: "20rem", display: "block", overflow: "visible" },
    closed: { width: "0", overflow: "hidden", transitionEnd: { display: "none" } }
  };
  ...
  return (
    ...
    <div className="flex h-full items-center">
      ...
      >
        <div className="flex h-full w-80 flex-col rounded-2xl bg-background">
          {/*Top Section */}
          <div className="flex grow flex-col px-2 py-3">
            {/* Search Bar */}
            <div className="mb-2 flex w-full items-center space-x-2 rounded-full bg-neutral-700">
              <MagnifyingGlassIcon className="ml-3 size-6 shrink-0 text-neutral-400" />
              <input
                className="h-9 w-full grow rounded-full bg-neutral-700 text-gray-100 focus:outline-none"
          ...
          {/*Bottom Section */}
          <div className="flex h-16 w-full shrink-0 flex-row rounded-b-2xl bg-neutral-700 p-3">
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger>
        ...
        rounded-lg px-1 py-2.5 transition duration-150 ease-out hover:bg-accent 
