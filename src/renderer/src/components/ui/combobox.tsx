  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild disabled={disabled} {...rest}>
        <button
          className={` flex h-12 w-full items-center border border-line justify-between rounded-md ${disabled ? "bg-muted border-none cursor-not-allowed" : "bg-input-primary"}  px-3 py-2 text-tx-primary `}
        >
